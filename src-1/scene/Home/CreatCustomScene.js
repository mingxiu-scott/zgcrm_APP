...
import { View, Text, ScrollView, TouchableOpacity, DeviceEventEmitter,Alert, TextInput, RadiModal } from 'react-native'
...
class CreatCustomScene extends PureComponent {
    ...
    postRequest() {
        ...
        fetch(url,opts)
            ...
            .then((responseText) => {
                DeviceEventEmitter.emit('CreateCustomScene','aaaa');
